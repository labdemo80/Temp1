...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2024 at 11:50 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('job_seeker','employer') DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `job_analytics`
  ADD CONSTRAINT `job_analytics_ibfk_1` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE CASCADE;
COMMIT;
